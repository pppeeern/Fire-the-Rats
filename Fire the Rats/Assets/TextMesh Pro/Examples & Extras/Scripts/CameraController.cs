...
namespace TMPro.Examples
{
    ...
    public class CameraController : MonoBehaviour
    {
        ...
        void GetPlayerUnityEngine.Input()
        {
            moveVector = Vector3.zero;

            // Check Mouse Wheel UnityEngine.Input prior to Shift Key so we can apply multiplier on Shift for Scrolling
            ...
            if (UnityEngine.Input.GetKey(KeyCode.LeftShift) || UnityEngine.Input.GetKey(KeyCode.RightShift) || touchCount > 0)
            {
                ...
                // Get UnityEngine.Input from Mobile Device
    ...
    internal class GetPlayerUnityEngine
    {
    }
